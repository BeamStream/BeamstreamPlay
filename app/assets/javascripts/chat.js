function startChat(userId) {
	var oldChatSocket = new WebSocket('ws://test.classwall.com/chat') 
	...
	$(".chatbox_own")
			.append(
					"<div id="
							...
							+ '<div class="my-avatar">'
							+ "<img src=" +localStorage["loggedUserProfileUrl"]
							+ ">"
							+'</div>'
...
function popit(userId, toWhom, name) {
	if(document.querySelector('#chat-' + toWhom) == null){
			var newChatSocket = new WebSocket('ws://test.classwall.com/startChat/' + userId + "/"+ toWhom)
