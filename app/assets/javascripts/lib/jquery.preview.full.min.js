...
(function(e) {
	...
	function a(h, f) {
		var g = {
			...
			elem : null,
			partials : {
				images_small : [ '<div class="thumbnail">',
						'<div class="controls">',
						'<a class="left" href="#">&#9664;</a>',
			...
			templates : {
				small : [
						...
						"</span>",
						"</div>",
						'<div class="action"><a href="#" class="nothumb">&#10005;</a></div>',
						"</div>" ].join(""),
				large : [
			...
			render : function(m) {
				...
				this.bind()
				 ...
				 /*To increase gray area height according to preview image*/ 
				var preview_height = parseInt($('div#discussionsView div.ask-info').height());
	...
	function d(g) {
		var f = {
			...
			bind : function() {
				e(".thumbnail.video a, .thumbnail.rich a").live("click",
						function(i) {
							i.preventDefault();
	...
	function c(h, f) {
		var g = {
			...
			display_attrs : [ "type", "original_url", "url", "title",
					...
					"provider_display", "provider_name", "safe", "html",
