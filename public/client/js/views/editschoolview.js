BS.EditSchoolView = Backbone.View.extend({
        events: {
        ...
        initialize:function () {   	
            ...
            BS.schoolBack = false;
            BS.newSchool = '';
            this.source = $("#tpl-school-edit").html();
