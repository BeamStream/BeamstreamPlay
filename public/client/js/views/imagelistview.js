            ...
            BS.user.fetch({ success:function(e) {                   
                ...
                $.ajax({
                        ...
                        success : function(docs) {
                                ...
                                +'<div class="gallery clearfix"></div><div class="gallery clearfix"><a href="'+doc+'" rel="prettyPhoto"><img src="'+doc+'" width="185px" height="141px"/></a></div></div></div>'    //doc contain path of the image
