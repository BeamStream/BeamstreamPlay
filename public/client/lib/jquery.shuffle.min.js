...
/**
 * jQuery Shuffle Plugin Uses CSS Transforms to filter down a grid of items
 * (degrades to jQuery's animate). Inspired by Isotope
 * http://isotope.metafizzy.co/ Use it for whatever you want!
 * 
