	...
	$.fn.prettyPhoto = function(pp_settings) {
     ...
     <div class="pp_overlay"></div>',
        ...
        <a href="#" class="pp_arrow_next">Next</a> \
							...
							flv_markup: '<object id="monFlash"  type="application/x-shockwave-flash" data="http://dudelidu.de/prettytest/player_flv_maxi.swf" width="{width}" height="{height}" /><param name="movie" value="http://dudelidu.de/prettytest/player_flv_maxi.swf" /><param name="allowFullScreen" value="true" /><param name="wmode" value="opaque"><param name="FlashVars" value="flv={path}width={width}&amp;height={height}&amp;autoplay=1&amp;autoload=1&amp;loop=&amp;showstop=1&amp;showvolume=1&amp;showfullscreen=1&amp;srt=1" />',
					...
					.fadeIn(function() {
						...
						case 'mp4':
							...
							*/
							...
							toInject = settings.flv_markup.replace(/{width}/g,correctSizes['width']).replace(/{height}/g,correctSizes['height']).replace(/{wmode}/g,settings.wmode).replace(/{path}/g,filename+'&');
							break;
