        ...
        _create:function(){
		 ...
		 var self = this;	
                ...
                b.element[0]!==c.activeElement&&(b.element.focus(),b.previous=f,setTimeout(function(){
                  ...
                  /**
					 * Edited by Aswathy for +Add New School option in
					 * autopopulate
					 */
                  if(!e.value)
                  { 
			  ...
			  console.log(schoolName);
                	  populateAddNewSchool(parentId,schoolName);
                  }
...
search:function(a,b){ 
     /**
		 * Edited by Aswathy for +Add New School option in autopopulate
		 */
    var self = this;
    if($(b.currentTarget).attr('name') == "schoolName"){
	schoolName =$(b.currentTarget).val();
...
_renderMenu:function(b,c){ 
	var d=this;
       if(d.element.attr('name') == "className"){
		a.each(c,function(a,c){
		d._renderItemnew(b,c)
		})
       }
       /* Edited By Aswathy for +Add New School option in autopopulate */
       else if(d.element.attr('name') == "schoolName"){
    	   a.each(c,function(a,c){
    			d._renderSchoolName(b,c)
    	   })
		    // d.element.attr('value' , $(d.element).val());
...
_renderItem:function(b,c){
             ...
             return a("<li></li>").data("item.autocomplete",c).append(a("<a></a>").text(c.label).append(a("<span class='class-image'></span>").text(c.data.classToReturn.className +", " +c.data.usersMap.Student+" STUDENTS, "+c.data.usersMap.Educator+" EDUCATOR, "+c.data.usersMap.Professional+" PROFFESSIONALS"))).appendTo(b)
    },
/** Added by Aswathy * */
_renderItemnew:function(b,c){
             return a("<li></li>").data("item.autocomplete",c).append(a("<a></a>").text(c.label).append(a("<span class='class-image'></span>").text(c.info))).appendTo(b)
    },
_renderSchoolName:function(b,c){
