...
_renderItem:function(b,c){
             ...
             return a("<li></li>").data("item.autocomplete",c).append(a("<a></a>").text(c.label).append(a("<span class='class-image'></span>").text(c.data.usersMap.Student+" STUDENTS, "+c.data.usersMap.Educator+" EDUCATOR, "+c.data.usersMap.Professional+" PROFFESSIONALS"))).appendTo(b)
    },
/** Added by Aswathy * */
