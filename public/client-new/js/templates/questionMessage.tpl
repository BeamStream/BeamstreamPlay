    ...
    <div class="ask-content">
            ...
            <div class="image-wrapper hovereffect" >
             ...
             <a id=" " href="#" class="delete_msg drag-rectangle" data-original-title="Flag this" style="visibility:hidden;"></a> 
                    ...
                    <input type="text" id="{{data.question.id.id}}-questionComment" class="add-question-comment add-question-comment-input" placeholder="Add Comments.."  onblur="this.placeholder = 'Add Comments..'" onfocus="this.placeholder = ''" placeholder="">
                    ...
                    <input type="text" id="{{data.question.id.id}}-questionsAnswer" class="add-question-answer add-question-comment-input" placeholder="Add Answers.."  onblur="this.placeholder = 'Add Answers..'" onfocus="this.placeholder = ''" placeholder="">
