        ...
        <div class="classic-information-block">
          <div class="classic-information-left">
            <h5>Class Information</h5>
              ...
              <div class="invite-small-select profile-select-block field" >
          ...
          <!--    <div class="invite-small-select profile-select-block  field" >
                ...
                <select id="startingDate" data-name="class.startingDate" name="startingDate"  class="selectpicker-info " style="display: none;">
                  <option selected="selected" >Calendar</option>
                </select>
                <div class="invite-small-arrow"><img src="/beamstream-new/images/white-arrow.png" width="15" height="8"></div>
              </div> -->
