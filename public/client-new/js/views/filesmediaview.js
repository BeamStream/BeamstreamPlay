                    ...
                    success : function(docs) {
                        if(docs.length != 0)  {
                            ...
                            content= '<div class="image-wrapper hovereffect" id="'+doc.id.id+'">'
                                ...
                                +'<div class="description-info"><div class="description-left"><p id="description-'+doc.id.id+'" class="doc-description">'+doc.documentDescription+'</p></div></div></a>'
            ...
            docFromComputer :function(){
                ...
                success : function(docs) {
                    ...
                    var content= '<div class="image-wrapper hovereffect" id="'+doc.id.id+'">'
                        ...
                        +' <div id="media-'+doc.id.id+'" >'
                        +' <h4 id="name-'+doc.id.id+'">'+doc.documentName+'</h4>'                                
                        +'<div class="description-info"><div class="description-left"><p class="doc-description" id="description-'+doc.id.id+'">'+doc.documentDescription+'</p></div></div></a>'
                        +' <div id="'+doc.id.id+'" class="comment-wrapper2">'
                        +'<a href="#" class="tag-icon" data-original-title="Search by Users"></a>   <a href="#" class="hand-icon rock_docs"></a>'
                        +'<a href="#" class="message-icon"></a>    <a href="#" class="share-icon"></a>'
                        +'</div></div>'
...
//                            	 $('#grid').append
                            ...
                            content= '<div class="image-wrapper hovereffect" id="'+image.id.id+'">'
                                ...
                                +'<div class="description-info"><div class="description-left"><p class="doc-description" id="description-'+image.id.id+'" >'+image.description+'</p></div></div></a>'
                        ...
                        success : function(videos) { 
                            ...
                            if(videos.length != 0)
                            {
                                ...
                                content= '<div class="image-wrapper hovereffect">'
	                                ...
	                                +'<div class="description-info"><div class="description-left"><p id="description-'+video.id.id+'" class="doc-description">'+video.description+'</p></div></div></a>'
...
//                            if(docs.length != 0)  {
                           ...
                           var content= '<div class="image-wrapper hovereffect">'
	                                ...
	                                +'<div class="description-info"><div class="description-left"><p id="description-'+audio.id.id+'" class="doc-description">'+audio.documentDescription+'</p></div></div></a>'
...
//                            if(docs.length != 0)  {
                            ...
                            var content= '<div class="image-wrapper hovereffect" id="'+ppt.id.id+'">'
	                                ...
	                                +'<div class="description-info"><div class="description-left"><p id="description-'+ppt.id.id+'" class="doc-description">'+ppt.documentDescription+'</p></div></div></a>'
