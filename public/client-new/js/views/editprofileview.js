BS.EditProfileView = Backbone.View.extend({
...
//	      'click #janrainEngageShare' : "ShowJanRainShare"
    ...
    initialize:function () {
        ...
        console.log('Initializing Edit Profile View');
        this.image = null;
    	this.video = null;
        
        this.source = $("#edit-profile-tpl").html();
    ...
    render:function (eventName) {
        ...
        $(this.el).html(this.template({primaryImage : BS.primaryImage, primaryVideo : BS.primaryVideo }));
         ...
         else
         {
             ...
             reader.onload = (function(f){
            	 ...
            	 return function(e){
    				...
    				$('#image-crop-view').html(BS.cropImageView.el);
    				$('#image-crop-popup').modal('show');
