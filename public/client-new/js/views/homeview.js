/***
	 ...
	 * Description           : Backbone view top menu
	 * ==============================================================================================
	 * Change History:
	 * ----------------------------------------------------------------------------------------------
	...
	//      this.showActiveClass();
	   },
	   
	   /**
	    * NEW THEME - edit profile page view
	    */
	   editProfile: function(eventName){
		   
		   eventName.preventDefault();
		   BS.editProfileView = new BS.EditProfileView();
	       BS.editProfileView.render();
	       $('#beam-popups').html(BS.editProfileView.el);
