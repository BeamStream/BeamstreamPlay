...
class UserMediaTest extends FunSuite with BeforeAndAfter {
  ...
  test("Get all media for a user") {
    ...
    val UserMediaObj = new UserMedia(new ObjectId, "", "", userId, new Date, "http://beamstream.com/Neel.png", UserMediaType.Image,DocumentAccess.Public, true, "", 0, List(),List())
  ...
  test("Get Profile Pic Of A User") {
    val userId = User.createUser(user)
    val UserMediaObj1 = new UserMedia(new ObjectId, "", "", userId, new Date, "http://beamstream.com/NeelK.png", UserMediaType.Image,DocumentAccess.Public, true, "", 0, List(),List())
    val UserMediaObj2 = new UserMedia(new ObjectId, "", "", userId, new Date, "http://beamstream.com/Neel.png", UserMediaType.Image,DocumentAccess.Public, false, "", 0, List(),List())
  ...
  test("Save Media For A User") {
    ...
    val UserMediaObj2 = new UserMedia(new ObjectId, "", "", userId, new Date, "http://beamstream.com/NeelK.png", UserMediaType.Image,DocumentAccess.Public, true, "", 0, List(),List())
    UserMedia.saveMediaForUser(UserMediaObj2)
  ...
  test("Get All Profile Pics Of A User") {
    ...
    UserMedia.saveMediaForUser(UserMediaObj1)
    UserMedia.saveMediaForUser(UserMediaObj2)
    val UserMediaObj3 = new UserMedia(new ObjectId, "", "", userId, new Date, "http://beamstream.com/Neel.png", UserMediaType.Video,DocumentAccess.Public, false, "", 0, List(),List())
